    ...
    if user_input:
        ...
        with st.chat_message("assistant"):
            ...
            with st.spinner(spinner_text):
                ...
                # If response contains circuit code, extract and display
                if '```python' in response and '```' in response:
                    ...
                    for i, part in enumerate(parts):
                        if part.startswith('python'):
                            # This is a python code block - remove the 'python' header
                            code = part[6:].strip()
            ...
            if cloud_key:
                ...
                if st.session_state.cloud_models:
                    ...
                    if use_custom:
                        ...
                        if custom_model != st.session_state.ollama_model or use_custom:
                        ...
                        ollama_model = st.selectbox(
                            ...
                            sorted_models,
                            index=sorted_models.index(st.session_state.ollama_model) if st.session_state.ollama_model in sorted_models else 0,
            ...
            if st.session_state.local_models:
                ...
                if use_custom:
                    ...
                    ollama_model = st.selectbox(
                        "💾 Select Local Model",
                        st.session_state.local_models,
                        index=st.session_state.local_models.index(st.session_state.ollama_model) if st.session_state.ollama_model in st.session_state.local_models else 0,
